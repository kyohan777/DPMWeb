	...
	function init() {
		...
		$("#jqGrid").jqGrid({
	        ...
	        colModel: [
	            ...
	            { label: '검증건수', 	   name: 'verifyCn',      sorttype:'int', width: 60, align: 'center', formatter:'integer',formatoptions: { defaultValue: '', thousandsSeparator: ',' }},	  
	            { label: '수정건수', 	   name: 'verifyUpdateCn',sorttype:'int', width: 60, align: 'center', formatter:'integer',formatoptions: { defaultValue: '', thousandsSeparator: ',' }},
